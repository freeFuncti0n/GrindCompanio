...
//------------------------------------------------------------------------------
// BLE LIVE TELEMETRY SERVICE (companion app real-time grind data)
//------------------------------------------------------------------------------
#define BLE_LIVE_SERVICE_UUID "aabbccdd-eeff-0011-2233-445566778899"             // Live telemetry service
#define BLE_LIVE_TELEMETRY_CHAR_UUID "bbccddee-ff00-1122-3344-556677889900"      // Packed live snapshot (Notify)
#define BLE_LIVE_CONTROL_CHAR_UUID "ccddeeff-0011-2233-4455-667788990011"        // Enable/disable streaming (Write)
#define BLE_LIVE_CMD_ENABLE 0x01
#define BLE_LIVE_CMD_DISABLE 0x02
#define BLE_LIVE_CMD_START_GRIND 0x10
#define BLE_LIVE_CMD_STOP_GRIND 0x11
#define BLE_LIVE_CMD_CONTINUE_PURGE 0x12
#define BLE_LIVE_CMD_RETURN_IDLE 0x13
#define BLE_LIVE_TELEMETRY_INTERVAL_MS 50                                         // ~20 Hz while grinding
#define BLE_LIVE_PAYLOAD_BYTES 20                                                 // float×3 + uint8×5 + pad
